...
namespace Wanaheim.Migrations
{
    ...
    [Migration("20190401170247_AddedPlayersTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wanaheim.Core.Domain.Player", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Wanaheim.Core.Domain.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Wanaheim.Core.Domain.Player", b =>
                {
                    b.HasOne("Wanaheim.Core.Domain.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
